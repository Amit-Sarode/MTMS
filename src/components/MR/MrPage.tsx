...
const [mrToEdit, setMrToEdit] = useState<IMr | null>(null);
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4">
      ...
      {/* Filters and Actions */}
      <div className="bg-white dark:bg-gray-800 p-4 flex flex-wrap items-center justify-between gap-4  rounded-lg shadow-sm  border-white">
        <div className="bg-white dark:bg-gray-800 flex items-center space-x-2 ">
          <button className="bg-white dark:bg-gray-800 dark:hover:bg-gray-700 text-black dark:text-white secondary flex items-center space-x-2 text-sm rounded-md border border-gray-300 ">
            <Filter size={16} />
            <span>Filter</span>
          </button>
          <select className="bg-white dark:bg-gray-800 rounded-md border border-gray-300 text-sm py-2">
      ...
      {/* MR Table */}
      <div className="bg-white dark:bg-gray-800 p-4 dark:hover:bg-gray-800 rounded-lg shadow-md border border-gray-200 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white dark:bg-gray-800 p-4 border-b border-gray-200">
              <tr className='bg-white dark:bg-gray-800 p-4'>
            ...
            <tbody className="dark:hover:bg-gray-800 divide-y divide-gray-200">
              {filteredMrList.map((mr) => (
                <React.Fragment key={mr.id}>
                  <tr 
                    onClick={() => handleRowClick(mr)} 
                    className={`bg-white dark:bg-gray-800 p-4 cursor-pointer dark:hover:bg-gray-800 transition-colors duration-150 ${selectedMr?.id === mr.id ? 'bg-blue-50' : ''}`}
                  >
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-right">
                      <div className="flex items-center justify-end space-x-2">
                        <button 
                          className="bg-white dark:bg-gray-800 p-4 p-1 text-sm rounded bg-gray-100 dark:hover:bg-gray-700 flex items-center"
                         onClick={(e) => {
  e.stopPropagation(); 
  mrEdit(mr);
}}
                        ...
                        {showMrForm && mrToEdit && (
  <div className="fixed inset-0 bg-white dark:bg-gray-800 p-4 bg-opacity-30 flex items-center justify-center z-50 p-4">
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto animate-fadeIn">
      <div className="p-6 ">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold">Edit Material Requisition</h2>
          <button 
            onClick={() => setShowMrForm(false)}
            className="text-gray-500 hover:text-gray-700 bg-white dark:bg-gray-800 p-4"
          >
            &times;
          </button>
        </div>
        ...
        />
                        ...
                        <button 
                          className="bg-white dark:bg-gray-800 p-4 p-1 text-sm rounded bg-white dark:bg-gray-800  dark:hover:bg-gray-800 flex items-center"
                          onClick={(e) => { 
                            e.stopPropagation(); 
                        ...
                        <button 
                          className="bg-white dark:bg-gray-800 p-4 p-1 text-sm rounded bg-white dark:bg-gray-800 bg-green-100  dark:hover:bg-gray-700 flex items-center text-green-700"
                  ...
                  {selectedMr?.id === mr.id && (
                    <tr className='bg-white dark:bg-gray-800 p-4'>
                      <td colSpan={6} className="bg-white dark:bg-gray-800 p-4 p-0 border-t-0">
                        <div className="p-4 bg-white dark:bg-gray-800 p-4 animate-fadeIn">
              ...
              {filteredMrList.length === 0 && (
                <tr>
                  <td colSpan={6} className="bg-white dark:bg-gray-800 p-4 px-4 py-8 text-center text-gray-500">
      ...
      {showSupplierModal && (
        <div className=" bg-white dark:bg-gray-800 p-4 fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-xl max-w-md w-full animate-fadeIn">
            <div className=" bg-white dark:bg-gray-800 p-4 p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold">Select Supplier</h2>
                <button 
                  onClick={() => setShowSupplierModal(false)}
                  className="bg-white dark:bg-gray-800 p-4 text-gray-500 dark:hover:bg-gray-800"
                >
                  &times;
                </button>
              </div>
