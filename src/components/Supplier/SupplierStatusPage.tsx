...
const SupplierStatusPage: React.FC<SupplierStatusPageProps> = ({ searchTerm }) => {
  ...
  if (isLoading) {
    return (
      <div className=" bg-white dark:bg-gray-800 p-4 flex justify-center items-center h-64">
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Supplier Table */}
      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md border border-gray-200 overflow-hidden dark:hover:bg-gray-800">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white dark:bg-gray-800 p-4 border-b border-gray-200 dark:hover:bg-gray-800">
              <tr>
            ...
            <tbody className="bg-white dark:bg-gray-800 p-4 divide-y divide-gray-200 dark:hover:bg-gray-800">
              {filteredSupplierList.map((supplier) => (
                <React.Fragment key={supplier.id}>
                  <tr 
                    onClick={() => handleRowClick(supplier)} 
                    className={`cursor-pointer dark:hover:bg-gray-800 transition-colors duration-150 ${selectedSupplier?.id === supplier.id ? 'bg-blue-50' : ''}`}
                  >
                   ...
                   <td className="bg-white dark:bg-gray-800 p-4 px-4 py-3 whitespace-nowrap ">
                      <span
                    ...
                    <td className="bg-white dark:bg-gray-800 p-4 px-4 py-3 whitespace-nowrap text-right dark:hover:bg-gray-800">
                      <div className="bg-white dark:bg-gray-800 p-4 flex items-center justify-end space-x-2">
                        {supplier.status === 'ready' && (
                          <button 
                            className="p-1 text-sm rounded bg-blue-100 dark:hover:bg-gray-800 flex items-center text-blue-700 bg-white dark:bg-gray-800 p-4"
                            onClick={(e) => { 
                              e.stopPropagation(); 
                        ...
                        <button 
                          className="bg-white dark:bg-gray-800 p-4 p-1 text-sm rounded bg-green-100  flex items-center text-green-700 dark:hover:bg-gray-800"
                  ...
                  {selectedSupplier?.id === supplier.id && (
                    <tr>
                      <td colSpan={7} className="bg-white dark:bg-gray-800 p-4 p-0 border-t-0 dark:hover:bg-gray-700">
                        <div className="p-4 bg-white dark:bg-gray-800 p-4 animate-fadeIn dark:hover:bg-gray-700">
              ...
              {filteredSupplierList.length === 0 && (
                <tr>
                  <td colSpan={7} className="bg-white dark:bg-gray-800 p-4 px-4 py-8 text-center text-gray-500 dark:hover:bg-gray-700">
